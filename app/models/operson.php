...
class oPerson extends oStandard {
    ...
    public function __construct() {
        ...
        $this->dEmail = new tEmail(['Fieldname' => 'Email', 'Label' => 'E-Mail']);
        $this->dPassword = new tPassword(['Fieldname' => 'Password', 'Label' => 'Password', 'Salt' => $this->mDBTable]);
        $this->dAdminrole = new tSelect(['Fieldname' => 'Adminrole',
            'Editable' => false,
            'AllowedValues' => [
